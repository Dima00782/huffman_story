...
TEST_P(EncodingAcceptanceTestFixedAlphabetLetter, EncodeAndDecode) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        TestCase{{"aa"},
                 "aaaaaaaaaaaa",
                 std::string("\x81\x30\xb0\x80\x01", 5)},
        TestCase{
            {"aa", "bb", " "},
            " aa bb aa ",
            std::string("\x20\x4c\x4c\x50\x26\x16\x18\x09\x05\x96\x01", 11)}));
